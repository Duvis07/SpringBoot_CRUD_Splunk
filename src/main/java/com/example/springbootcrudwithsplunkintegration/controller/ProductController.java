...
public class ProductController {
    ...
    public Product save(@RequestBody Product product) {
        logger.info("started hiting the save api from controller");
       var product1=   productService.save(product);
        logger.info("saved the product  from service in controller" +product1);
        return product1;
